...
class TypewiseTest(unittest.TestCase):
    ...
    def test_classify_temperature_breach_for_passive_cooling(self):
        self.assertEqual(typewise_alert.classify_temperature_breach('PASSIVE_COOLING', 30), 'NORMAL')
    ...
    def test_classify_temperature_breach_for_med_active_cooling(self):
        self.assertEqual(typewise_alert.classify_temperature_breach('MED_ACTIVE_COOLING', 30), 'NORMAL')
    ...
    def test_invalid_cooling_type_raises_value_error(self):
        with self.assertRaises(ValueError):
            typewise_alert.classify_temperature_breach('INVALID_COOLING', 30)

    def test_invalid_alert_target_raises_value_error(self):
        with self.assertRaises(ValueError):
            typewise_alert.get_alert_method('INVALID_ALERT_TARGET')
